...
class CTRAINWrapper(nn.Module):
    ...
    def evaluate(self, test_loader, test_samples=np.inf, eval_method='ADAPTIVE', **kwargs):
        """
        ...
        Args:
            ...
            eval_method (str or list, optional): The certification method to use. Options are
                'IBP', 'CROWN', 'CROWN-IBP', 'ADAPTIVE', 'ZONOTOPE', or a list of methods.
                Default is 'ADAPTIVE'.
            **kwargs: Additional arguments forwarded to the certification method.
        ...
        return eval_model(self.bounded_model, test_loader, n_classes=self.n_classes, eps=eps_std, test_samples=test_samples, method=eval_method, device=self.device, **kwargs)

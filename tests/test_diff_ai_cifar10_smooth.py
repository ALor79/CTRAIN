"""
Trains CNN7_Shi on CIFAR-10 using DiffAI with zonotope bounds and crelu_smooth.
"""
...
print(f"\n{'='*60}")
print(f"  Zonotope - smooth — {NUM_EPOCHS} epochs, eps={EPS:.5f}, CIFAR-10")
print(f"{'='*60}")
